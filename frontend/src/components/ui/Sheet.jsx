  ...
  ({ side = 'right', className, children, ...props }, ref) => (
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        side === 'top' && 'left-0 right-0 top-0 h-[--radix-sheet-height] w-full data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top',
        side === 'bottom' && 'left-0 right-0 bottom-0 h-[--radix-sheet-height] w-full data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom',
        className
      )}
      {...props}
    >
...
export { Sheet, SheetOverlay, SheetContent, SheetHeader, SheetFooter, SheetTitle, SheetDescription, SheetTrigger, SheetClose };