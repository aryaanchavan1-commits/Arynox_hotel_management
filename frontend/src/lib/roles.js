...
export const ROLE_MODULES = {
  admin: ['dashboard', 'rooms', 'bookings', 'guests', 'users', 'restaurant', 'kitchen', 'housekeeping', 'pos', 'venue', 'channels', 'website', 'reports', 'assistant', 'settings'],
  manager: ['dashboard', 'rooms', 'bookings', 'guests', 'restaurant', 'kitchen', 'housekeeping', 'pos', 'venue', 'channels', 'website', 'reports', 'assistant', 'settings'],
