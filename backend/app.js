...
app.get('/', (req, res) => {
  ...
  res.send(`<!doctype html><html><head><meta charset="utf-8"><title>Arynox_Hotel_ERP - API</title>
...
<div class="card">
  ...
  <p class="muted">Hotel + Restaurant + POS + AI backend (serverless on Vercel).</p>
