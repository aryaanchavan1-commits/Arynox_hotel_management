# Contribute to Arynox_Hotel_ERP

Arynox_Hotel_ERP is an open-source software and we all know that community contributions lie at the heart of any open-source software. It is the essence of an open-source that a diverse group of individuals collaborate and innovate the best possible solutions.

Here are the ways you can contribute to the Arynox_Hotel_ERP project.
...
In Arynox_Hotel_ERP we follow a modular approach to bring functionalities into the system. The system has its native modules for different features.
...
If you have an idea to make the system more optimized and you can make the system work better then it's time to make a pull request at the [Arynox_Hotel_ERP Github repository](https://github.com/webkul/hotelcommerce).

The better-written code the better the software performance.

### Report Security Issues

Arynox_Hotel_ERP values the contributions of the security research community, and we look forward to working with you to minimize risk to Arynox_Hotel_ERP users.

If you have found a security issue in Arynox_Hotel_ERP, please do not use the issue tracker and don't publish it publicly. Instead, report the security issue to [support@arynoxhotelerp.com](mailto:support@arynoxhotelerp.com) or contact [Arynox_Hotel_ERP Support](https://webkul.uvdesk.com/en/customer/create-ticket/). So that we can act on it immediately to avoid as much damage as we can.
...
Bugless development is impossible, we can just try to leave as minimum bugs in the system as we can. At Arynox_Hotel_ERP also we try our best to make the system free of bugs.
...
You can report a bug either on our GitHub [Issues](https://github.com/webkul/hotelcommerce/issues) or on our [Forum](http://forums.arynoxhotelerp.com/).
