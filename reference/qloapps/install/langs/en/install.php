...
return array(
	...
	'translations' => array(
		...
		'You are using PHP %s version. Soon, the latest PHP version supported by Arynox_Hotel_ERP will be PHP 8.1. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.1 now!' => 'You are using PHP %s version. Soon, the latest PHP version supported by Arynox_Hotel_ERP will be PHP 8.1. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.1 now!',
		...
		'Yes' => 'Yes',
		'No' => 'No',
		'Installing demo data is a good way to learn how to use Arynox_Hotel_ERP if you have not used it before. This demo data can later be erased using module Arynox_Hotel_ERP Data Cleaner which comes pre-installed with this installation.' => 'Installing demo data is a good way to learn how to use Arynox_Hotel_ERP if you have not used it before. This demo data can later be erased using module Arynox_Hotel_ERP Data Cleaner which comes pre-installed with this installation.',
		'Country' => 'Country',
		...
		'I agree to receive the Newsletter and promotional offers from Arynox_Hotel_ERP.' => 'I agree to receive the Newsletter and promotional offers from Arynox_Hotel_ERP.',
		...
		'To use Arynox_Hotel_ERP, you must <a href="%1$s" target="_blank">create a database</a> to collect all of your website\'s data-related activities.' => 'To use Arynox_Hotel_ERP, you must <a href="%1$s" target="_blank">create a database</a> to collect all of your website\'s data-related activities.',
		'Please complete the fields below in order for Arynox_Hotel_ERP to connect to your database. ' => 'Please complete the fields below in order for Arynox_Hotel_ERP to connect to your database.',
		...
		'Arynox_Hotel_ERP Installation Assistant' => 'Arynox_Hotel_ERP Installation Assistant',
		'Forum' => 'Forum',
		'Blog' => 'Blog',
		...
		'Tutorials' => 'Tutorials',
		'See our Arynox_Hotel_ERP tutorials' => 'See our Arynox_Hotel_ERP tutorials',
		'Installation Assistant' => 'Installation Assistant',
		'To install Arynox_Hotel_ERP, you need to have JavaScript enabled in your browser.' => 'To install Arynox_Hotel_ERP, you need to have JavaScript enabled in your browser.',
		...
		'Find just the right features on Arynox_Hotel_ERP Addons to make your hospitality business a success.' => 'Find just the right features on Arynox_Hotel_ERP Addons to make your hospitality business a success.',
		...
		'You have just finished installing Arynox_Hotel_ERP. Thank you for using Arynox_Hotel_ERP!' => 'You have just finished installing Arynox_Hotel_ERP. Thank you for using Arynox_Hotel_ERP!',
		...
		'I just built an online hotel booking website with Arynox_Hotel_ERP!' => 'I just built an online hotel booking website with Arynox_Hotel_ERP!',
		'See all the features here : https://docs.arynoxhotelerp.com/' => 'See all the features here : https://docs.arynoxhotelerp.com/',
		'Tweet' => 'Tweet',
		'Share' => 'Share',
		'Google+' => 'Google+',
		'Pinterest' => 'Pinterest',
		'LinkedIn' => 'LinkedIn',
		'We are currently checking Arynox_Hotel_ERP compatibility with your system environment' => 'We are currently checking Arynox_Hotel_ERP compatibility with your system environment',
		...
		'Arynox_Hotel_ERP compatibility with your system environment has been verified!' => 'Arynox_Hotel_ERP compatibility with your system environment has been verified!',
		...
		'Arynox_Hotel_ERP requires at least 128 MB of memory to run: please check the memory_limit directive in your php.ini file or contact your host provider about this.' => 'Arynox_Hotel_ERP requires at least 128 MB of memory to run: please check the memory_limit directive in your php.ini file or contact your host provider about this.',
		'Welcome to the Arynox_Hotel_ERP %s Installer' => 'Welcome to the Arynox_Hotel_ERP %s Installer',
		'Installing Arynox_Hotel_ERP is quick and easy. In just a few moments, you will become part of a community. You are on the way to creating your own hotel booking website that you can manage easily every day.' => 'Installing Arynox_Hotel_ERP is quick and easy. In just a few moments, you will become part of a community. You are on the way to creating your own hotel booking website that you can manage easily every day.',
		...
		'The language selection above only applies to the Installation Assistant. Once Arynox_Hotel_ERP is installed, you can choose the language of your website from over %d translations, all for free!' => 'The language selection above only applies to the Installation Assistant. Once Arynox_Hotel_ERP is installed, you can choose the language of your website from over %d translations, all for free!',
	),
);